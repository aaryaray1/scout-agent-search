...
- Ingested pages are in-memory only and vanish on restart. Durable storage is Phase 2.
...
- Incremental indexing. Right now any corpus change forces a full re-embed; ingested pages should be upsertable by source URL/hash without rebuilding everything.
